...
"origin_story" is 2-3 short narrative sentences that set a heroic, playful tone (style example: "In a world of squeaky toys and forbidden socks, one dog rises."). "achievement_badge" is a short 2-4 word fun title (example: "Sock Thief"). "certificate_virtue" is a short 2-4 word single virtue or quality — not a compound "X and Y" phrase — completing the sentence "for ___ and [special ability]" on a formal certificate — theme-appropriate, and standalone (do not prepend "outstanding" or similar, the phrase itself is the whole clause) (examples: "elegance" for a graceful theme, "boundless courage" for an adventurous theme, "quiet cunning" for a sly theme, "regal kindness" for a noble theme). It must not reuse or closely paraphrase any word likely to appear in "special_ability" — the two sit side by side in the same certificate sentence, so keep their vocabulary distinct. Do not include a rank or tier field of any kind — that is assigned separately.`;
